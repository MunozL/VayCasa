...
export default function PhotoUploader({ addedPhotos, onChange }) {
  ...
  //function to (handle onclick) remove a photo
          ...
          addedPhotos.map((link) => (
            <div className=" h-32 flex relative" key={link}>
              ...
              <button
                ...
                className=" cursor-pointer absolute bottom-1 right-1 text-white bg-black rounded-xl bg-opacity-50 p-1"
              >
                <svg
              ...
              <button
                ...
                className=" cursor-pointer absolute bottom-1 left-1 text-white bg-black rounded-xl bg-opacity-50 p-1"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
